	...
	<div class="main-content">
            ...
            <div class="card wow fadeIn mb-5" data-wow-delay="0.3s">
                ...
                <h2 class="text-center mb-4 mt-4 font-weight-bold">All Notes
                    ...
                    <?php
                        $i=1;
                        $resultsetyear=$conn->query("SELECT * FROM notes WHERE n_active='yes'");
                        while($row=$resultsetyear->fetch_assoc()){
                            $resultuser=$conn->query("SELECT * FROM user_data WHERE u_id='{$row['u_id']}' ");
                        ...
                        echo "<td><a href=\"allnotes.php?de={$row['n_id']}\"><i class='far fa-eye'></i></i></a> </td>";
                        echo "<td><a href=\"allnotes.php?rmvnt={$row['n_id']}\"><i class='far fa-trash-alt'></i></a> </td>";
